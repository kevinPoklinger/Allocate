...
const addProdMiddlewares = (app, options) => {
  ...
  app.use(require('prerender-node').set('protocol', 'https').set('prerenderServiceUrl', isStaging ? 'http://staging.lift.co:3001' : 'http://lift.co:3001'));
  app.use(compression());
  sitemap(app);
  ...
  app.use(publicPath, express.static(outputPath, {
    ...
    setHeaders: (res, contentPath) => {
      ...
      if (contentPath.includes('index.html') || contentPath.includes('pace.min.js')) {
